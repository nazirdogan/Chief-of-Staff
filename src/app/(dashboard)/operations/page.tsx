  ...
  return (
    <div style={{ maxWidth: 800, margin: '0 auto', padding: '24px 16px' }}>
      ...
      <div style={{ display: 'flex', gap: 12, marginBottom: 24 }}>
        <button
          ...
          style={{
            ...
            background: overnightDone ? 'rgba(74,222,128,0.1)' : c.surface,
            color: overnightDone ? '#4ADE80' : c.text,
      ...
      <div style={{
        ...
        border: `1px solid ${c.border}`, background: c.brassMuted,
      }}>
