...
import { SCENES, VO } from './constants-v6';
import { IntroScene } from './scenes/v6/IntroScene';
import { BriefingScene } from './scenes/v6/BriefingScene';
import { ChatScene } from './scenes/v6/ChatScene';
import { MontageScene } from './scenes/v6/MontageScene';
import { AutonomyScene } from './scenes/v6/AutonomyScene';
import { TaglineScene } from './scenes/v6/TaglineScene';
import { CTAScene } from './scenes/v6/CTAScene';

loadPlayfair();
loadDMSans();
loadJetBrainsMono();

export const DonnaDemoV6: React.FC = () => {
  return (
