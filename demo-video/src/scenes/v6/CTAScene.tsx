...
export const CTAScene: React.FC = () => {
  ...
  return (
    <div style={{
      ...
      display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 28, opacity,
    }}>
      <div style={{
        fontSize: 42, fontFamily: '"Playfair Display", serif', fontWeight: 700, color: COLORS.white,
      ...
      <div style={{
        ...
        fontSize: 16, fontFamily: '"JetBrains Mono", monospace', fontWeight: 400,
