...
/* ─────────────────────────────────────────────
   Intelligence feed items (V3 hero)
───────────────────────────────────────────── */
const feedItems = [
...
export default function V4Page() {
  ...
  return (
    <>
      {/* ── Styles: V3 animations + input focus ── */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&family=Inter:wght@300;400;500;600;700&family=JetBrains+Mono:wght@300;400;500;600&display=swap');
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .blink-dot { animation: dotBlink 1.8s ease-in-out infinite; }
      ...
      <div style={{ fontFamily: "'Inter', 'Satoshi', system-ui, sans-serif", overflowX: "hidden" }}>
              ...
              <Reveal delay={120}>
                <div style={{ paddingTop: 8 }}>
                  <p style={{ fontSize: 17, lineHeight: 1.8, color: "#4a4a5a", marginBottom: 24 }}>
                    ...
                    <em style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 19, fontStyle: "italic" }}>know</em>{" "}
            ...
            <div style={{ marginTop: 80, display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
              {[
                ...
                <Reveal key={number} delay={i * 80}>
                  ...
                  >
                    <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: "0.2em", color, marginBottom: 16 }}>
                      {number}
                    </div>
                    <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 22, fontWeight: 600, color: c.midnight, marginBottom: 12, lineHeight: 1.3 }}>
                      {title}
                    </h3>
          ...
          <div style={{ maxWidth: 1080, margin: "0 auto" }}>
            <Reveal>
              <div style={{ marginBottom: 72, textAlign: "center" }}>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: c.dawn, marginBottom: 20 }}>
                  HOW IT WORKS
                </div>
                <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(36px, 4vw, 52px)", fontWeight: 400, lineHeight: 1.15, color: c.midnight, margin: 0 }}>
              ...
              {[
                ...
                <Reveal key={step} delay={i * 100}>
                  ...
                  >
                    ...
                    >
                      <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 13, fontWeight: 500, color, letterSpacing: "0.05em" }}>
                        {step}
                      </span>
                    </div>
                    <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, letterSpacing: "0.28em", textTransform: "uppercase", color, marginBottom: 12 }}>
                      {verb}
                    </div>
                    <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 21, fontWeight: 600, color: c.midnight, lineHeight: 1.3, marginBottom: 16 }}>
                      {headline}
                    </h3>
        ...
        >
          ...
          >
            <Reveal>
              <div>
                <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: "0.25em", textTransform: "uppercase", color: c.dawn, marginBottom: 24 }}>
                  SAMPLE BRIEFING
                </div>
                <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(34px, 4vw, 50px)", fontWeight: 400, lineHeight: 1.15, color: "#fff", marginBottom: 24 }}>
                ...
                <p style={{ fontSize: 16, lineHeight: 1.8, color: c.mist, marginBottom: 32 }}>
                  Every morning at the time you set, Donna sends one message to Telegram.
            ...
            <Reveal delay={120}>
              ...
              >
                ...
                <div style={{ background: "#232E3C", borderRadius: 12, borderTopLeftRadius: 4, padding: "16px 18px" }}>
                  ...
                  <div style={{ marginTop: 12, fontSize: 10, color: "#4a6070", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.05em" }}>
                    DONNA · 7 items · 3.1s
                  </div>
                </div>
              </div>
              ...
              {[
                ...
                <Reveal key={label} delay={i * 70}>
                  ...
                  >
                    ...
                    <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 9, letterSpacing: "0.22em", textTransform: "uppercase", color: accent, marginBottom: 14 }}>
                      {label}
                    </div>
                    <h3 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 23, fontWeight: 600, color: c.midnight, lineHeight: 1.25, marginBottom: 16 }}>
                      {headline}
                    </h3>
          ...
          <div style={{ maxWidth: 1080, margin: "0 auto" }}>
            <Reveal>
              <div style={{ textAlign: "center", marginBottom: 64 }}>
                <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(32px, 3.5vw, 46px)", fontWeight: 400, color: "#fff", margin: 0, lineHeight: 1.2 }}>
              ...
              {[
                ...
                <Reveal key={label} delay={i * 80}>
                  <div style={{ padding: "48px 32px", textAlign: "center", borderRight: i < 3 ? "1px solid rgba(255,255,255,0.06)" : "none" }}>
                    <div style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(42px, 4vw, 58px)", fontWeight: 300, color: accent, lineHeight: 1, marginBottom: 12, letterSpacing: "-0.02em" }}>
        ...
        <section style={{ background: c.paper, padding: "100px 24px", borderTop: `1px solid ${c.stone}`, borderBottom: `1px solid ${c.stone}` }}>
          <div style={{ maxWidth: 760, margin: "0 auto", textAlign: "center" }}>
            <Reveal>
              ...
              <p style={{ marginTop: 32, fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: "0.18em", textTransform: "uppercase", color: c.mist }}>
                THAT&apos;S DONNA.
              </p>
            </Reveal>
          </div>
        ...
        >
          ...
          <Reveal>
            <div style={{ position: "relative", zIndex: 1 }}>
              ...
              <h2 style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: "clamp(40px, 6vw, 72px)", fontWeight: 400, lineHeight: 1.1, color: "#fff", margin: "0 auto 24px", maxWidth: 680, letterSpacing: "-0.01em" }}>
              ...
              {submitted ? (
                <div style={{ display: "inline-flex", alignItems: "center", gap: 12, background: `${c.sage}18`, border: `1px solid ${c.sage}40`, borderRadius: 10, padding: "16px 28px" }}>
                  ...
                  <span style={{ color: c.sage, fontSize: 14, fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.05em" }}>
              ...
              <p style={{ marginTop: 20, fontSize: 12, color: "#4a6080", fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.06em" }}>
        ...
        >
          <div>
            <span style={{ fontFamily: "'Cormorant Garamond', Georgia, serif", fontSize: 20, fontWeight: 500, color: "#fff", letterSpacing: "0.02em" }}>
              Donna
            </span>
            <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: "0.12em", color: "#3a4060", marginTop: 6, textTransform: "uppercase" }}>
              PERSONAL INTELLIGENCE
            </p>
          </div>
          <div style={{ display: "flex", gap: 32, flexWrap: "wrap" }}>
            {["Privacy", "Terms", "Security"].map((item) => (
              <a key={item} href="#" style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: "0.12em", textTransform: "uppercase", color: "#3a4060", textDecoration: "none" }}>
                {item}
              </a>
            ))}
          </div>
          <p style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 10, letterSpacing: "0.08em", color: "#2a3050", textTransform: "uppercase" }}>
            &copy; 2026 DONNA
          </p>
        </footer>
      </div>
